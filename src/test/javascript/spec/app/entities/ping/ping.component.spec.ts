  ...
  describe('Ping Management Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(PingComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.pings[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
